import allImage from "@/assets/img/all-images/bg/bg3.png";
...
const serviceData = [{
  ...
  image: service1,
  hashtags: ["#BrandIdentityDesign", "#DesignYourBrand", "#LogoAndBranding", "#BrandRecognition"],
  aosDuration: 900
}, {
  title: "E-commerce Shop",
  image: service2,
  hashtags: ["#EcommerceExperts", "#DesignYourBrand", "#ShopFromHome", "#DiscoverAndShop"],
  aosDuration: 1000
}, {
  title: "UI/UX Designer",
  image: service3,
  hashtags: ["#DesignInspiration", "#UserCenteredDesign", "#CreativeDesign", "#DesignThinking"],
  aosDuration: 1100
}, {
  title: "Digital Marketing",
  image: service4,
  hashtags: ["#WebDevelopment", "#FrontendDevelopment", "#BackendDevelopment", "#ProgrammingLife"],
  aosDuration: 1200
}];
const Service = () => {
  return <div className="service1-section-area sp6" style={{
          ...
          <Col lg={5} className="m-auto">
            <div className="service-header heading1 text-center space-margin60">
              ...
              <h2 className="text-anime-style-3">
                Innovative Services for Modern Brands
              </h2>
            </div>
          </Col>
        </Row>
